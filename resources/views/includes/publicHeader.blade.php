        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href=" {{URL::route('drivers')}} ">Drivers<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href=" {{URL::route('rides')}} ">Rides</a>
            </li>

            <li class="nav-item active">
                <a class="nav-link" href=" {{URL::route('evaluations')}} ">Evaluations</a>
              </li>
