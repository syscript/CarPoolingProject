    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateRegister' , Auth::user()->id) }}">
                        @csrf
                        {{-- Name --}}
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-6 offset-md-4">
                            You have to Add Car To Create journys
                            <a href="{{ route('addCarIndex') }}"><button class="btn btn-primary">Add Car</button></a>
                        </div>
                    </div>
                    @endif()
